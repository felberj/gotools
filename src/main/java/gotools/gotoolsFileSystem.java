...
@FileSystemInfo(
		...
		factory = gotoolsFileSystem.MyFileSystemFactory.class)
public class gotoolsFileSystem implements GFileSystem {
	 ...
	 */
	public gotoolsFileSystem(FSRLRoot fsFSRL, ByteProvider provider) {
		this.fsFSRL = fsFSRL;
	...
	public void mount(TaskMonitor monitor) {
		monitor.setMessage("Opening " + gotoolsFileSystem.class.getSimpleName() + "...");
	...
	public static class MyFileSystemFactory
			implements GFileSystemFactoryFull<gotoolsFileSystem>, GFileSystemProbeFull {

		@Override
		public gotoolsFileSystem create(FSRL containerFSRL, FSRLRoot targetFSRL,
				ByteProvider byteProvider, File containerFile, FileSystemService fsService,
				TaskMonitor monitor) throws IOException, CancelledException {

			gotoolsFileSystem fs = new gotoolsFileSystem(targetFSRL, byteProvider);
			fs.mount(monitor);
			return fs;
		}
